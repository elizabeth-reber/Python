...
elizabeth.name = "Elizabeth", "elizabeth.szathmary@gmail.com"
rowley.name = "Rowley", "rowleyismycat@gmail.com"
hamish.name = "Hamish", "hamishisacharacterfromtv@gmail.com"

#Have the first user make 3 deposits, 1 withdrawal and display balance
elizabeth.make_deposit(100,000).make_deposit(100,000).make_deposit(100,000).make_withdrawal(50,000).display_user_balance()
...
Hamish.make_deposit(10.00).make_deposit(5.00).make_withdrawl(1.00).make_withdrawal(1.00).display_user_balance()
...
elizabeth.transfer_money(hamish,250)
hamish.display_user_balance()
elizabeth.display_user_balance()
